...
# if n == 1:
#     print('диапозон значений I четверти: x > 0, y > 0')
# elif n == 2:
#     print('диапозон значений II четверти: x < 0, y > 0')
# elif n == 3:
#     print('диапозон значений III четверти: x < 0, y < 0')
# elif n == 4:
#     print('диапозон значений IV четверти: x > 0, y < 0')
# else: print('данной четверти не существует')
...
print(f' расстояние между точками А и В равно: {round(d, 2)}')
